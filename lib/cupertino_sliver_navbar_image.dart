...
const double _kNavBarLargeTitleHeightExtension = 52 * 3;
...
const double _kNavBarShowLargeTitleThreshold = 10.0 * 3;
...
///
/// The [CupertinoSliverNavigationBarImage] must be placed in a sliver group such
...
/// to also has a [CupertinoNavigationBar] or a [CupertinoSliverNavigationBarImage]
...
/// simultaneously.
///
/// By default, only one [CupertinoNavigationBar] or [CupertinoSliverNavigationBarImage]
...
///
/// [CupertinoSliverNavigationBarImage] has its text scale factor set to 1.0 by default
...
/// [CupertinoSliverNavigationBarImage]'s components inside a [MediaQuery] with the
...
///
/// {@tool dartpad}
/// This example shows [CupertinoSliverNavigationBarImage] in action inside a [CustomScrollView].
///
...
class CupertinoSliverNavigationBarImage extends StatefulWidget {
  ...
  @override
  State<CupertinoSliverNavigationBarImage> createState() => _CupertinoSliverNavigationBarImageState();
}
...
class _CupertinoSliverNavigationBarImageState extends State<CupertinoSliverNavigationBarImage> {
    ...
    final Widget navBar = _wrapWithBackground(
      ...
      child: DefaultTextStyle(
        ...
        child: Stack(
          fit: StackFit.expand,
          children: <Widget>[
            AnimatedOpacity(duration: _kNavBarTitleFadeDuration, opacity: showLargeTitle ? 1 : 0, child: image),
            Positioned(
              bottom: -4,
              left: 0,
              right: 0,
...
/// [CupertinoSliverNavigationBarImage]'s `leading` slot when
